...
def mask_test_edges_dgl(graph, adj, false_to_true_ratio = 1.0):
    src, dst = graph.edges()
    ...
    test_edges_false = []
    while len(test_edges_false) < len(test_edges) * false_to_true_ratio:
        idx_i = np.random.randint(0, adj.shape[0])
        idx_j = np.random.randint(0, adj.shape[0])
        if idx_i == idx_j:
            continue
    ...
    val_edges_false = []
    while len(val_edges_false) < len(val_edges) * false_to_true_ratio:
        idx_i = np.random.randint(0, adj.shape[0])
        idx_j = np.random.randint(0, adj.shape[0])
        if idx_i == idx_j:
            continue
